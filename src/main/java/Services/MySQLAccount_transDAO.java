...
public class MySQLAccount_transDAO implements IAccount_transDAO {
    ...
    //--------------------------------------------------CRUD------------------------------------------------------------
    final String INSERT = "INSERT INTO account_trans (TXN_ID,AMOUNT,FUNDS_AVAIL_DATE,TXN_DATE,TXN_TYPE_CD,ACCOUNT_ID,EXECUTION_BRANCH_ID,TELLER_EMP_ID) VALUES (?,?,?,?,?,?,?)";
    ...
    public void insert(Account_trans at) throws DAOException {
        ...
        try{
            ...
            stat.setLong(1,at.getTxnID());
            stat.setDouble(2,at.getAmount());
            stat.setDate(3, new Date(at.getFundsAvailDate().getTime()));
            stat.setDate(4,new Date(at.getTxnDate().getTime()));
            stat.setString(5,at.getTxnTypeCD());
            stat.setLong(6,at.getAccountID());
            stat.setLong(7,at.getExecutionBranchID());
            stat.setLong(8,at.getTellerEmpID());
